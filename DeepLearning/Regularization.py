...
in regularization mode -- by setting the lambd input to a non-zero value. We use "lambd" instead of "lambda"
...
def forward_propagation_with_dropout(X, parameters, keep_prob=0.5):
    ...
    return A3, cache  # Step 2: convert entries of D2 to 0 or 1 (using keep_prob as the threshold)
